...
<section class="section_add">
    <h1>Войти</h1>
    <form class="regist" action="php/authorization.php" method="post" enctype="multipart/form-data">
        <label>
            <input placeholder="Логин" name="login" type="text">
            <input placeholder="Пароль" name="password" type="password">
            <input type="submit" value="Войти"></label>
    ...
    <a href="login.php">Еще нет аккаунта? Зарегистрироваться</a>
</section>
<footer>
    <div class="footer1">
        <div>
